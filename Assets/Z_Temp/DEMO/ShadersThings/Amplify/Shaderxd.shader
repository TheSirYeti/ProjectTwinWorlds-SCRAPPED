...
Shader "Shaderxd"
{
	Properties
	{
		_PannerSpeed("PannerSpeed", Vector) = (3,8,0,0)
		...
		_TextureMultiply("TextureMultiply", Float) = 1
		_ScaleNoise("ScaleNoise", Float) = 3.5
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float mulTime51 = _Time.y * _TimeScale;
			float2 temp_cast_1 = (_PannerSpeed.y).xx;
			float2 uv_TexCoord47 = i.uv_texcoord * _Tiling;
			float3 ase_worldPos = i.worldPos;
			float2 panner53 = ( mulTime51 * temp_cast_1 + ( float3( uv_TexCoord47 ,  0.0 ) * _TextureMultiply * ase_worldPos ).xy);
			float simplePerlin2D55 = snoise( panner53*_ScaleNoise );
			simplePerlin2D55 = simplePerlin2D55*0.5 + 0.5;
			float temp_output_6_0 = step( simplePerlin2D55 , 0.4 );
			o.Alpha = ( ( temp_output_6_0 + ( ( 1.0 - temp_output_6_0 ) * 0.3 ) ) * _Opacity );
		}
...
/*ASEBEGIN
Version=18900
1913;97;1920;922;6363.372;670.3776;4.295576;True;False
Node;AmplifyShaderEditor.Vector2Node;46;-2067.007,-123.6178;Inherit;False;Property;_Tiling;Tiling;2;0;Create;True;0;0;0;False;0;False;1,3;0.75,0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;50;-1909.932,363.7947;Inherit;False;Property;_TimeScale;TimeScale;3;0;Create;True;0;0;0;False;0;False;0.05;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-1776.522,123.0254;Inherit;False;Property;_TextureMultiply;TextureMultiply;4;0;Create;True;0;0;0;False;0;False;1;0.48;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;49;-1782.099,224.6451;Inherit;False;Property;_PannerSpeed;PannerSpeed;0;0;Create;True;0;0;0;False;0;False;3,8;3,8;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-1364.558,242.4977;Inherit;False;Property;_ScaleNoise;ScaleNoise;5;0;Create;True;0;0;0;False;0;False;3.5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-311.0585,496.0229;Inherit;False;Property;_Opacity;Opacity;6;0;Create;True;0;0;0;False;0;False;0.4;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-430.596,236.3463;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;-387.0585,-55.97015;Inherit;False;Property;_DimensionColor;DimensionColor;1;0;Create;True;0;0;0;False;0;False;0.122241,0.4201443,0.6320754,0;0.4023674,0.5832331,0.6226415,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8CA99D0846AE2E6CFF6BA02199DECCDCA753DB29